    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 font-sans scroll-smooth">
      ...
      <header className="relative h-96 flex items-center justify-center bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="text-center text-white">
          ...
          <p className="text-xl">From the Students of Class 12 (H.B)</p>
          <Link href="#event-details" className="mt-6 inline-block px-6 py-3 bg-white text-blue-600 rounded-lg hover:px-12  hover:duration-300 duration-300">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-700 text-center leading-relaxed">
          As the students of Class 12 (H.B), we stand at the threshold of a new chapter in our lives. Today, we take a moment to reflect on the incredible journey we&apos;ve shared with you. Your guidance, love, and unwavering support have shaped us into who we are today. This farewell is not just a goodbye, but a heartfelt thank you for everything you&apos;ve done for us. We will carry your lessons and memories in our hearts forever.
        </p>
      </section>
      ...
      <section className="bg-blue-50 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg text-gray-700 text-center leading-relaxed">
            To our beloved teachers and faculty, your dedication and passion have been the foundation of our growth. You&apos;ve not only taught us lessons from books but also life lessons that will guide us forever. For every word of encouragement, every moment of patience, and every act of kindness — we, the students of Class 12 (H.B), are eternally grateful.
          </p>
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-700 text-center leading-relaxed">
          From the first day we walked into these halls as students to the moments we shared in classrooms, labs, and events — every memory is a treasure. Here&apos;s a glimpse of our journey together:
        </p>
        <div className="mt-8 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-6 bg-white rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-2">First Day</h3>
              <p className="text-gray-600">The beginning of our unforgettable journey as little students.</p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-2">Classroom Memories</h3>
              <p className="text-gray-600">Lessons, laughter, and lifelong friendships in classes.</p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-2">Farewell</h3>
              <p className="text-gray-600">A bittersweet goodbye to a cherished chapter as Inter students.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="event-details" className="py-16 px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-700 text-center leading-relaxed">
          We, the students of Class 12 (H.B), invite you to celebrate this special moment with us. Let&apos;s come together to relive the memories and create new ones.
        </p>
        <div className="mt-8 text-center">
      ...
      <footer className="bg-gray-900 py-8 text-white text-center">
        ...
        <p className="mt-4 text-sm text-gray-500">&copy; Muhammad Shariq | Students of Class XII - C (H.B)</p>
      </footer>
    </div>
  );
};
